...
export default function InstitutionalLogin() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const selectedInstitutionalData = institutionsLists.filter((item =>  item.name === selectedInstitute));
    navigate("/login", {state: {selectedInstitutionalData: selectedInstitutionalData}})
  }
      ...
      <Card className={classes.root}>
        <CardContent>
          ...
          <div className={Classes.formContainer}>
            <div className={Classes.enterCollege}>Enter by selecting your college</div>
            <form
